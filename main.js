...
const canciones = [
  "Viviendo en la Paradoja.mp3",
  "Zensorial.mp3",
  "Virus de Metal.mp3",
  "Siempre el Perdedor.mp3",
  "Las rimas que más te divierten.mp3",
  "Pensamientos Oscuros.mp3",
  "La Lucha de Nuestro Pueblo.mp3",
  "No Quiero Trabajar.mp3",
  "La Orquesta de la Muerte.mp3",
  "Reino de Locura.mp3",
  "Recuerdos Melodicos.mp3",
  "Lucha por Tus Sueños.mp3",
  "Locos en el Trono.mp3",
  "La Llorona en la Noche.mp3",
  "La Leyenda del Entrenador.mp3",
  "Controlados por Máquinas.mp3",
  "La Mezcla de Sonidos.mp3",
  "Monstruos en el Espejo.mp3",
  "La Bestia Oscura.mp3",
  "Guerra de Ángeles y Demonios.mp3",
  "Guerreros de Grecia.mp3",
  "Gracias Madre Mía.mp3",
  "El niño en la sombra.mp3",
  "El Hubiera Sí Existe.mp3",
  "La muñeca blanca.mp3",
  "El Cazador de Almas.mp3",
  "Cumbia de Recuerdos.mp3",
  "Desamor Perdido.mp3",
  "Carrera de Asfalto.mp3",
  "La Historia de un Hacker.mp3",
  "Camioneta de Aventura.mp3",
  "Falsedad en el Aire.mp3",
  "Caminos de Sangre.mp3",
  "El Renacer.mp3",
  "Bizarro Mundo de Payasos.mp3",
  "El Apocalipsis de la Humanidad.mp3",
  "Bailando con Fantasmas.mp3",
  "Del Norte al Rock.mp3",
  "Aventuras de Niñez.mp3",
  "Aquí No Hay Novedad.mp3",
